	...
	for _, tc := range []test{
		{
			...
			want: `title,alternativeIdentifiers,alternativeIdentifierLabels,radGeneralMaterialDesignation,levelOfDescription,culture,publicationStatus,accessConditions
